...
export default function Page() {
  return (
    <div className="h-screen flex flex-col bg-[#040e18]">
      <div className="h-[10%] bg-[#01162B] flex items-center justify-between px-8">
        <Logo3 />
        <Navbar />
      </div>

      <div className="flex-1 flex justify-center items-center">
        <div className="bg-[#141a21] p-8 rounded-lg shadow-lg w-full max-w-4xl">
          ...
          <form className="space-y-6">
            ...
            <div className="flex justify-center mt-6">
              <button onClick={() => {}} className="w-full sm:w-auto border px-4 py-2 rounded-2xl text-white">
                Submit report
              </button>
            </div>
          </form>
